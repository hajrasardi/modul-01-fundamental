...
const fullTimer = new FulltimeEmployee("Alice");
fullTimer.addWorkingHours("09:00", "10:00");

console.log(`${fullTimer.name} - Total Gaji: Rp${fullTimer.totalSalary()}`);
// Output yang diharapkan: Rp1.125.000

const partTimer = new ParttimeEmployee("Bob");
partTimer.addWorkingHours("13:00", "17:00");
console.log(`${partTimer.name} - Total Gaji: Rp${partTimer.totalSalary()}`);
// Output yang diharapkan: Rp120.000
